...
class DiskFileManager(object):
    ...
    def __init__(self, conf, logger):
        ...
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("Threads per disk = "+ str(threads_per_disk))
...
class DiskFileWriter(object):
    ...
    def _finalize_put_ram(self, metadata, target_path):
        # Write the metadata before calling fsync() so that both data and
        # metadata are flushed to disk.
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("1 = "+str(target_path)+"="+str(datetime.now())+"***")
        #write_metadata(self._fd, metadata)
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("2 = "+str(target_path)+"="+str(datetime.now())+"***")
        ...
        #fsync(self._fd)
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("3 = "+str(target_path)+"="+str(datetime.now())+"***")
        ...
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("4 = "+str(target_path)+"="+str(datetime.now())+"***")
        #invalidate_hash(dirname(self._datadir))
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("5 = "+str(target_path)+"="+str(datetime.now())+"***")
        # After the rename completes, this object will be available for other
        # requests to reference.
        #renamer(self._tmppath, target_path)
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("6 = "+str(target_path)+"="+str(datetime.now())+"***")
        ...
        #with open("/home/ubuntu/WFIN.txt", "a") as tran_file:
        #    tran_file.write("7 = "+str(target_path)+"="+str(datetime.now())+"\n")
    ...
    def put(self, metadata):
        ...
        is_ram=<is_ram>;
        if is_ram:
            self._threadpool.force_run_in_thread(self._finalize_put_ram, metadata, target_path)
        else:
            self._threadpool.force_run_in_thread(self._finalize_put, metadata, target_path)
